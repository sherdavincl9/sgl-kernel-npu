...
struct SasaKernelParamsArch35 {
    ...
    __aicore__ inline SasaKernelParamsArch35() {}
    __aicore__ inline SasaKernelParamsArch35(GM_ADDR q_, GM_ADDR k_, GM_ADDR v_, GM_ADDR selectIdx_,
...
struct SasaFullQuantKernelParamsArch35 {
    ...
    __aicore__ inline SasaFullQuantKernelParamsArch35() {}
    __aicore__ inline SasaFullQuantKernelParamsArch35(GM_ADDR q_, GM_ADDR k_, GM_ADDR v_, GM_ADDR selectIdx_,
                                                      GM_ADDR blockTable_, GM_ADDR selectNumIdx_,
                                                      GM_ADDR actualQseqlen_, GM_ADDR actualKvseqlen_,
                                                      GM_ADDR qDequantScale_, GM_ADDR kDequantScale_,
                                                      GM_ADDR vDequantScale_, GM_ADDR o_, GM_ADDR softmaxLse_,
                                                      GM_ADDR workSpace_, GM_ADDR tiling_)
        : q(q_),
          k(k_),
          v(v_),
