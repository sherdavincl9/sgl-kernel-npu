...
struct CopyL0CToDstQuantMode<ArchTag, float, float, ScaleGranularity::NO_QUANT> {
    static constexpr auto VALUE = QuantMode_t::NoQuant;
};

#if (__CCE_AICORE__ == 310)
template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, float, ScaleGranularity::PER_TENSOR> {
...
template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, half, ScaleGranularity::NO_QUANT> {
    static constexpr auto VALUE = QuantMode_t::F322F16;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, half, ScaleGranularity::PER_TENSOR> {
    // static constexpr auto VALUE = QuantMode_t::F322F16;
...
template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, bfloat16_t, ScaleGranularity::NO_QUANT> {
    static constexpr auto VALUE = QuantMode_t::F322BF16;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, bfloat16_t, ScaleGranularity::PER_TENSOR> {
    // static constexpr auto VALUE = QuantMode_t::F322BF16;
...
template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, uint8_t, ScaleGranularity::PER_TENSOR> {
    static constexpr auto VALUE = QuantMode_t::QF322B8_PRE;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, uint8_t, ScaleGranularity::PER_CHANNEL> {
    static constexpr auto VALUE = QuantMode_t::VQF322B8_PRE;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, int8_t, ScaleGranularity::PER_TENSOR> {
    static constexpr auto VALUE = QuantMode_t::QF322B8_PRE;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, float, int8_t, ScaleGranularity::PER_CHANNEL> {
    static constexpr auto VALUE = QuantMode_t::VQF322B8_PRE;
};

// CopyL0CToGm output int32
template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, int32_t, int32_t, ScaleGranularity::NO_QUANT> {
    static constexpr auto VALUE = QuantMode_t::NoQuant;
};

// CopyL0CToGm cast int32_t to fp16
template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, int32_t, half, ScaleGranularity::PER_TENSOR> {
    static constexpr auto VALUE = QuantMode_t::DEQF16;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, int32_t, half, ScaleGranularity::PER_CHANNEL> {
    static constexpr auto VALUE = QuantMode_t::VDEQF16;
};

// CopyL0CToGm cast int32 to uint8/int8
template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, int32_t, uint8_t, ScaleGranularity::PER_TENSOR> {
    static constexpr auto VALUE = QuantMode_t::REQ8;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, int32_t, uint8_t, ScaleGranularity::PER_CHANNEL> {
    static constexpr auto VALUE = QuantMode_t::VREQ8;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, int32_t, int8_t, ScaleGranularity::PER_TENSOR> {
    static constexpr auto VALUE = QuantMode_t::REQ8;
};

template <class ArchTag>
struct CopyL0CToDstQuantMode<ArchTag, int32_t, int8_t, ScaleGranularity::PER_CHANNEL> {
    static constexpr auto VALUE = QuantMode_t::VREQ8;
};
...
enum class CopyL0CToUBMode { NO_SPLIT = 0, SPLIT_M, SPLIT_N, RESERVED };

template <class ArchTag, class TensorSrc, class TensorDst, CopyL0CToUBMode CopyMode = CopyL0CToUBMode::NO_SPLIT,
          ScaleGranularity DEQUANT_GRANULARITY = ScaleGranularity::NO_QUANT, bool ReluEnable = false,
          class Enable = void>
