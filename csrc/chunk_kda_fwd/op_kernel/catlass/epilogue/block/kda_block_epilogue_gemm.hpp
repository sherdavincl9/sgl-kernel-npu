...
#ifndef CATLASS_KDA_BLOCK_EPILOGUE_GEMM_HPP
#define CATLASS_KDA_BLOCK_EPILOGUE_GEMM_HPP
...
public:
    ...
    CATLASS_DEVICE
    BlockEpilogue(Arch::Resource<ArchTag> &resource, GemmCoord blockShape_, Params const &params_, uint32_t ubByteStart = 0)
...
#endif // CATLASS_KDA_BLOCK_EPILOGUE_GEMM_HPP
