...
#ifndef CATLASS_KDA_BLOCK_EPILOGUE_MLA_SOFTMAX_HPP
#define CATLASS_KDA_BLOCK_EPILOGUE_MLA_SOFTMAX_HPP
...
public:
        ...
        uint32_t kSeqTileRound)
    {
        if (kSeqTile <= FLOAT_VECTOR_SIZE) {
            ...
            AscendC::DataCopy(tempTensor, src, AscendC::DataCopyParams(curRowNum, HALF_VECTOR_SIZE / BLOCK_SIZE, (kSeqTileRound - FLOAT_VECTOR_SIZE) / FLOAT_BLOCK_SIZE, 0));
            AscendC::PipeBarrier<PIPE_V>();
...
#endif // CATLASS_KDA_BLOCK_EPILOGUE_MLA_SOFTMAX_HPP
