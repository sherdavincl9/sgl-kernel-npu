...
#ifndef CATLASS_KDA_BLOCK_MMAD_GEMM_HPP
#define CATLASS_KDA_BLOCK_MMAD_GEMM_HPP
        ...
        bool isFirstBlock, bool hasNextBlock, uint32_t singleIdx)
    {
        ...
        for (uint32_t kIdx = 0; kIdx < kLoops; kIdx++) {
            ...
            if (shuffleKIdx == lastTileIdx && hasNextBlock) {
                kGmActualNext = (firstTileIdxNext == kLoopsNext - 1) ? (actualShapeNext.k() - firstTileIdxNext * maxKPerBlock) : maxKPerBlock;
...
#endif // CATLASS_KDA_BLOCK_MMAD_GEMM_HPP
