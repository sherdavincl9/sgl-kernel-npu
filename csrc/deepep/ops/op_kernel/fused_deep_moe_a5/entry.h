...
#define CALL_FUSED_DEEP_MOE                                                                                 \
    ...
    op.Init(x, expert_ids, gmm1_weight, gmm1_weight_scale, gmm2_weight, gmm2_weight_scale, expert_scales,   \
            ...
            expert_smooth_scales, share_smooth_scales, x_active_mask, profile_buffer, output, share_output, \
            expertTokenNums, workspace, nullptr, &tiling_data);                                             \
    op.Process()
...
fused_deep_moe(GM_ADDR x, GM_ADDR expert_ids, GM_ADDR gmm1_weight, GM_ADDR gmm1_weight_scale, GM_ADDR gmm2_weight,
               ...
               GM_ADDR expert_smooth_scales, GM_ADDR share_smooth_scales, GM_ADDR x_active_mask, GM_ADDR profile_buffer,
               GM_ADDR output, GM_ADDR share_output, GM_ADDR expertTokenNums, GM_ADDR workspace, GM_ADDR tiling)
{
    icache_preload(8);
